...
# Python to calculate the multidimensional normal using the monte carlo using MPI reduce and SUM to parallelize the process.
...
def normal_pdf(x_vals, mu, sigma):
    ...
    centered_samples = x_vals - mu.reshape(1, -1)
...
def main():
    ...
    samples, mean, variance, error = mc_sim.run_integration(num_variables, normal_pdf, mu, sigma)
